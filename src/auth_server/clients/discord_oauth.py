...
api_endpoint = config.get(AuthServerConfigKey.DISCORD_API_ENDPOINT)
scope = config.get(AuthServerConfigKey.DISCORD_OAUTH_SCOPE)
client_id = config.get(AuthServerConfigKey.DISCORD_OAUTH_CLIENT_ID)
redirect_uri = config.get(AuthServerConfigKey.DISCORD_OAUTH_REDIRECT_URI)
client_secret = config.get(AuthServerConfigKey.DISCORD_OAUTH_CLIENT_SECRET)
