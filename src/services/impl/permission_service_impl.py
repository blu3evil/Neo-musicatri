...
from modo.entity.permission_entity import PermissionEntity, UserPermissionEntity
...
from services.abs.permission_service import PermissionService, PermissionTag
