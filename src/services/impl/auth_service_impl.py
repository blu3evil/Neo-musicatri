...
from modo.entity.session_entity import DiscordOAuth2SessionEntity, UserSessionEntity
...
from services.abs.permission_service import PermissionTag, PermissionService
from services.abs.auth_service import AuthService, AuthStrategy, AuthStrategyContext
...
class DiscordOAuth2CodeStrategy(AuthStrategy):
    ...
    def upsert_discord_user(code) -> Tuple[int, DiscordOAuth2CredentialDTO]:
        ...
        log.info(domains.to_dict())  # 打印discord user消息日志
