...
class ServerAuthContext(WebApplicationContextV1):
    ...
    def _init_models(self):
        ...
        import server_auth.domain.models as models
        models.init(self.app)

    def _init_views(self):
        """ 初始化路由 """
        from server_auth.views.static_blueprint import static_bp_v1
        from server_auth.views.system_blueprint import status_bp_v1
        from server_auth.views.auth_blueprint import auth_bp_v1
        from server_auth.views.user_blueprint import user_bp_v1
        ...
        from server_auth.views.admin.user_blueprint import admin_user_bp_v1
